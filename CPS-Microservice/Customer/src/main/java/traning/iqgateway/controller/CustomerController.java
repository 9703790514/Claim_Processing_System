...
public class CustomerController {
    ...
    @GetMapping("/login")
    public ResponseEntity<CustomerEO> getCustomerByEmailAndPassword(
        ...
        return ResponseEntity.ok(customers.get(0));  // only first customer
    }
    ...
    public ResponseEntity<List<PoliciesEO>> getPoliciesByCustomerId(@PathVariable Integer customerId) {
        List<PoliciesEO> policies = policiesService.getPoliciesByCustomerId(customerId);
